<?php
   ...
   $sql ="SELECT * FROM hospital WHERE name = '대구병원'";
   $sql2 ="SELECT * FROM people WHERE hospitalization_hospital='대구병원' AND hospitalization_date IS NOT NULL AND (discharge_date IS NULL OR discharge_date='0000-00-00') AND (deathday IS NULL OR deathday='0000-00-00 00:00:00')";
   ...
   $sql ="SELECT * FROM people WHERE country='대한민국' AND hospitalization_hospital = '대구병원' AND positive IS NOT NULL AND positive != ''"; 
   $sql2 ="SELECT * FROM people WHERE hospitalization_hospital='대구병원' AND deathday IS NOT NULL AND deathday != '00-00-00 00:00:00'";
   $Modernanum = "SELECT * FROM people WHERE vaccination_hospital = '대구병원' AND vaccine = 'Moderna'";
   $Modernanum2 = "SELECT * FROM people WHERE vaccination_hospital = '대구병원' AND vaccine = 'Moderna' AND (2st_vaccination_date is NOT NULL AND 2st_vaccination_date != '0000-00-00' )";
   $Pfizernum = "SELECT * FROM people WHERE vaccination_hospital = '대구병원' AND vaccine = 'Pfizer'";
   $Pfizernum2 = "SELECT * FROM people WHERE vaccination_hospital = '대구병원' AND vaccine = 'Pfizer' AND (2st_vaccination_date is NOT NULL AND 2st_vaccination_date != '0000-00-00' )";
...
<link rel="stylesheet" href="hhHome.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-white u-header" id="sec-e270"><div class="u-align-left u-clearfix u-sheet u-sheet-1">
        <img class="u-image u-image-default u-image-1" src="images/signature2.png" alt="" data-image-width="1230" data-image-height="468">
          ...
          <div class="u-layout-row">
            <div class="u-align-left u-container-style u-image u-layout-cell u-left-cell u-size-24 u-image-1">
              <div class="u-container-layout u-container-layout-1">
                <h1 class="u-custom-font u-font-source-sans-pro u-text u-text-palette-3-base u-title u-text-1">대구병원</h1>
                ...
                <div class="u-container-layout u-container-layout-2">
                  <h3 class="u-text u-text-3">보유 백신</h3>
                    <p class="u-text u-text-2">모더나 : <br>
                      ...
                      <?php echo "<TD> <a href='dg_m_select.php'> 접종 </a> </TD>"; ?>
                      
                      <p class="u-text u-text-2">화이자 : <br>
                        <?php echo  $row['residual_Pfizer']; "%<br>"; ?><br>
                      <?php echo "<TD> <a href='dg_p_select.php'> 접종 </a> </TD>"; ?>
                  </p>
                </div>
              </div>
