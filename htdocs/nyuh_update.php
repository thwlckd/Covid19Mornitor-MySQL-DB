<?php
   ...
   $sql="SELECT * FROM people WHERE ssn='".$_POST['ssn']."' AND (hospitalization_hospital = 'New York University Hospital' OR hospitalization_hospital is NULL)";
   $ret=mysqli_query($con, $sql);
   if($ret){
      $count = mysqli_num_rows($ret);
      if($count==0){
         echo $_POST['ssn'], " NOT FOUND.<br>";
         echo "<br> <a href='nyuh_select.php'><--Previous screen</a>";
         exit();
      }
   }
   else{
...
<FORM METHOD="post" ACTION="nyuh_update_result.php">
   ...
   Hospitalzation hospital:<INPUT TYPE ="text" NAME="hospitalization_hospital" VALUE><br>
