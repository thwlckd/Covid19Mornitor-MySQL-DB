...
dt {font-weight:bold}
dl.bot_rgt {background: #F78181 url(/data/201012/IJ12929573850979/c_tl.gif) top left no-repeat; margin:5px 0 0 50px; padding:0; float:left; margin-right:10px; width:40%; display:inline;}
...
<dl class="top_rgt">
   ...
   <dl class="top_rgt">
     <dt>production correction</dt>
       <FORM METHOD="post" ACTION="update_Moderna_production_us.php">
  ...
  <dl class="top_lft">
     <dt>order quantity</dt>
       <FORM METHOD="post" ACTION="order_Moderna_us.php">
        <br>United States : <INPUT TYPE = "text" NAME = "order_Moderna" VALUE=>
