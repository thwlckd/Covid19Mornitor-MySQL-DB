...
<div class="table-users">
   <div class="header"><h3>환자 정보</h3></div>
<?php
	$con=mysqli_connect("localhost", "root", "1234", "covid-19") or die("covid-19 접속 실패 !!");	
	$sql ="SELECT * FROM people WHERE country='대한민국' AND hospitalization_hospital = '경북대병원'"; 
    ...
    echo "<TABLE border=1>";
    echo "<TR>";
    echo "<TH>주민번호</TH><TH>이름</TH><TH>성별</TH><TH>전화번호</TH><TH>나라</TH><TH>거주지역</TH><TH>확진</TH><TH>검사일</TH>";
    echo "<TH>접종병원</TH><TH>백신종류</TH><TH>1차백신 접종일</TH><TH>2차백신 접종일</TH><TH>부작용</TH><TH>입원병원</TH><TH>입원일</TH><TH>퇴원일</TH><TH>사망일</TH>";
    echo "</TR>";
...
<HTML>
	...
	<BODY>
		<FORM METHOD="post" ACTION="knu_update.php">
			정보 수정 - 이름: <INPUT TYPE = "text" NAME="name">  주민번호: <INPUT TYPE = "text" NAME="ssn">
			<INPUT TYPE="submit" VALUE="수정">
			<br> <a href='knu.php'> <-홈페이지로 돌아가기</a><br><br>
		</FORM>
	</BODY>
</HTML>
