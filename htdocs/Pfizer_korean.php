...
<script type="text/javascript">google.load("visualization", "1", {packages:["corechart"]});google.setOnLoadCallback(drawChart);
 ...
 <dl class="top_rgt">
    ...
    <dl class="top_rgt">
		<dt>생산량 갱신</dt>
        <FORM METHOD="post" ACTION="update_pfizer_production.php">
  ...
  <br><br><br>
	<dl class="top_lft">
		<dt>백신 주문</dt>
        <FORM METHOD="post" ACTION="order_Pfizer.php">
	      <br>대한민국 : <INPUT TYPE = "text" NAME = "order_Pfizer" VALUE=>
