...
<?php
	...
	$sql ="SELECT * FROM people WHERE hospitalization_hospital = 'Johns Hopkins Hospital'"; 
...
<HTML>
	...
	<BODY>
		<FORM METHOD="post" ACTION="jhh_update.php">
        Modify the information - NAME: <INPUT TYPE = "text" NAME="name" VALUE>  SSN: <INPUT TYPE = "text" NAME="ssn" VALUE>
			<INPUT TYPE="submit" VALUE="Modify">
			<br> <a href='jhh.php'> <-Back to Johns Hopkins Hospital Homepage</a><br><br>
		</FORM>
	</BODY>
</HTML>
