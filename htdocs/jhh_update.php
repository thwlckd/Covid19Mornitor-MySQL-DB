<?php
   ...
   $sql="SELECT * FROM people WHERE country = 'United states' AND ssn='".$_POST['ssn']."' AND (hospitalization_hospital = 'Johns Hopkins Hospital' OR hospitalization_hospital is NULL)";
   $ret=mysqli_query($con, $sql);
   if($ret){
      $count = mysqli_num_rows($ret);
      if($count==0){
         echo $_POST['ssn'], " NOT FOUND.<br>";
         echo "<br> <a href='jhh_select.php'><--Previous screen</a>";
         exit();
      }
   }
   else{
...
<FORM METHOD="post" ACTION="jhh_update_result.php">
   ...
   hospitalizaion hospital:<INPUT TYPE ="text" NAME="hospitalization_hospital" VALUE><br>
