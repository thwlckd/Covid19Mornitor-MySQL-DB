<?php
   ...
   function vaccinate_M($con, $hospital, $ssn){
      ...
      if($row) {
         ...
         echo "<br> <a href='mc.php'> <--Mayo Clinic</a> ";
         exit();
      }
      ...
      $sql_h = "UPDATE hospital SET residual_Moderna = residual_Moderna - 1 WHERE name = 'Mayo Clinic'";
   ...
   $name = $_POST["name"];
   $ssn = $_POST["ssn"];
   $vaccination_hospital = 'Mayo Clinic';
