<?php
   ...
   function vaccinate_P($con, $hospital, $ssn){
      echo "<h1> ⦁접종 결과 </h1>";
      ...
      $sql_h = "UPDATE hospital SET residual_Pfizer = residual_Pfizer - 1 WHERE name = '영남대병원'";
   ...
   $name = $_POST["name"];
   $ssn = $_POST["ssn"];
   $vaccination_hospital = '영남대병원';

   vaccinate_P($con, $vaccination_hospital, $ssn);
