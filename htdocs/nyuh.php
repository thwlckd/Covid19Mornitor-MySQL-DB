<?php
   ...
   $sql ="SELECT * FROM hospital WHERE name = 'New York University Hospital'";
   $sql2 ="SELECT * FROM people WHERE hospitalization_hospital='New York University Hospital' AND hospitalization_date IS NOT NULL AND (discharge_date IS NULL OR discharge_date='0000-00-00') AND (deathday IS NULL OR deathday='0000-00-00 00:00:00')";
   ...
   $sql ="SELECT * FROM people WHERE country='United States' AND hospitalization_hospital = 'New York University Hospital' AND positive IS NOT NULL AND positive != ''"; 
   $sql2 ="SELECT * FROM people WHERE hospitalization_hospital='New York University Hospital' AND deathday IS NOT NULL AND deathday != '00-00-00 00:00:00'";
   $Modernanum = "SELECT * FROM people WHERE vaccination_hospital = 'New York University Hospital' AND vaccine = 'Moderna'";
   $Modernanum2 = "SELECT * FROM people WHERE vaccination_hospital = 'New York University Hospital' AND vaccine = 'Moderna' AND (2st_vaccination_date is NOT NULL AND 2st_vaccination_date != '0000-00-00' )";
   $Pfizernum = "SELECT * FROM people WHERE vaccination_hospital = 'New York University Hospital' AND vaccine = 'Pfizer'";
   $Pfizernum2 = "SELECT * FROM people WHERE vaccination_hospital = 'New York University Hospital' AND vaccine = 'Pfizer' AND (2st_vaccination_date is NOT NULL AND 2st_vaccination_date != '0000-00-00' )";
...
<link rel="stylesheet" href="hhHome.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-white u-header" id="sec-e270"><div class="u-align-left u-clearfix u-sheet u-sheet-1">
        <img class="u-image u-image-default u-image-1" src="images/signature6.png" alt="" data-image-width="1230" data-image-height="468">
          ...
          <div class="u-layout-row">
            <div class="u-align-left u-container-style u-image u-layout-cell u-left-cell u-size-24 u-image-1">
              <div class="u-container-layout u-container-layout-1">
                <h1 class="u-custom-font u-font-source-sans-pro u-text u-text-palette-6-base u-title u-text-1">New York University Hospital</h1>
                ...
                <div class="u-container-layout u-container-layout-2">
                  <h3 class="u-text u-text-3">Remaning Vaccine</h3>
                    <p class="u-text u-text-2">Moderna : <br>
                      ...
                      <?php echo "<TD> <a href='nyuh_m_select.php'> Inoculaion </a> </TD>"; ?>
                      
                      <p class="u-text u-text-2">Pfizer : <br>
                        <?php echo  $row['residual_Pfizer']; "%<br>"; ?><br>
                      <?php echo "<TD> <a href='nynh_p_select.php'> Inoculaion </a> </TD>"; ?>
                  </p>
                </div>
              </div>
